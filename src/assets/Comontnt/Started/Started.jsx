...
const Started = () => {
    return (
        <div className='mx-auto container space-y-4 mt-32'>
            <h2 className='text-6xl font-bold text-center'>Get Started in 3 Steps</h2>
            <p className='text-center opacity-50'>Start using premium digital tools in minutes, not hours.</p>
            <div className='flex gap-8 justify-center mt-8'>
                <div className='bg-gray-100 p-20 text-center space-y-4 rounded-xl border-3 border-gray-300'>
